...
void Lcd_Send_Nibble (char byte)
{
    ...
    LATD |= upper_bits;
    LATCbits.LATC1 = 1;; _delay((unsigned long)((1)*(8000000UL/4000.0))); LATCbits.LATC1 = 0;; _delay((unsigned long)((1)*(8000000UL/4000.0)));;
    LATD &= ~upper_bits;
...
_Bool Lcd_Driver_Busy (void)
{
    ...
    _Bool driver_busy_flag = PORTDbits.RD7;
